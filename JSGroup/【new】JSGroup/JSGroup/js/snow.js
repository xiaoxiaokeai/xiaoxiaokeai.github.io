...
!function($){
  ...
  $.fn.moving = function(options){    //beccause the "z-dex" this function disappears.
    var settings = $.extend({}, defaults, options),// protect  the defaults
        el = $(this),
        flakes = [],
        canvas = el.get(0),
        ...
        canvas.width = window.innerWidth;   //return the window width
        canvas.height = window.innerHeight; //return the windw  height
